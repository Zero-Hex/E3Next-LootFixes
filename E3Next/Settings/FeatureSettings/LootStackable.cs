...
namespace E3Core.Settings.FeatureSettings
{
	public  class LootStackable : BaseSettings
	{
		...
		public Boolean LootNonStackable = false;
		...
		public void LoadData()
		{
			...
			LoadKeyData("Settings", "Loot Non Stackables (On/Off)", parsedData, ref LootNonStackable);
		...
		public IniData CreateSettings(string fileName)
		{
			...
			section.Keys.AddKey("Loot Non Stackables (On/Off)", "Off");
